...
HD_PWD='C:/Users/Gabi Pirvulescu/Desktop/CTI-ENG-AN 1/SEM 2/VHDL/PROJECT VHDL/CHICKEN_INVADERS/CHICKEN_INVADERS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CHICKEN_INVADERS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CHICKEN_INVADERS.tcl
