...
HD_PWD='C:/Users/Gabi Pirvulescu/Desktop/CTI-ENG-AN 1/SEM 2/VHDL/PROJECT VHDL/CHICKEN_INVADERS/CHICKEN_INVADERS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CHICKEN_INVADERS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CHICKEN_INVADERS.tcl -notrace
